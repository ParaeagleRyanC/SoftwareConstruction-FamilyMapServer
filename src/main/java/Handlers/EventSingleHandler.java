...
import Services.EventSingleService;
        ...
        try {
            if (exchange.getRequestMethod().equalsIgnoreCase("get")) {
                ...
                if (requestHeaders.containsKey("Authorization")) {
                    ...
                    EventSingleService service = new EventSingleService();
                    EventSingleResult result = service.getSingleEvent(urlParam[2], authToken);
